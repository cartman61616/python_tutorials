...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        print "escape pod"
        print "\n"
        print "You're running down the central corridor to the Weapons armor when"
        ...
        if action == "shoot!":
            ...
            print "The Gothon stop, tries not to laugh, then busts out laughing and can't move."
